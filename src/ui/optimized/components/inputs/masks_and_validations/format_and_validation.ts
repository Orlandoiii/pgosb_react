...
} from "../../../../../utilities/validators/account_validators";
import { formatAsDecimal, formatAsInt } from "../../../../../utilities/formatters/number_formatters";
import { isValidDocument } from "../../../../../utilities/validators/document_validators";
import { isValidEmail } from "../../../../../utilities/validators/email_validators";
import { isValidIP } from "../../../../../utilities/validators/ip_validators";
import { formatDate, formatDateTime } from "../../../../../utilities/formatters/date_formatters";
...
function formatValue(initValue: string, value: string, type: InputType): string {
  switch (type) {
    case "Amount":
    case "Decimal":
    ...
    case "DateTime":
      return formatDateTime(value, '13/08/2024 00:00:00', '13/08/2025 23:59:59');
    default:
      return value;
  }
}

function validateValue(value: string, bankCode: string, type: InputType): { isValid: boolean; error: string } {
  var error: string = "";
