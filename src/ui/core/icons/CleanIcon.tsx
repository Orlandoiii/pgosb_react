...
export default function CleanIcon({ color = "black", height = '24px', width = '24px' }) {
    return (
        <svg fill={color} xmlns="http://www.w3.org/2000/svg" height={height} width={width} viewBox="0 -960 960 960"  >
