...
interface NotificationModalContextProvider {
    show: boolean,
    initMessage?: string,
    initType?: string
}

export default function NotificationModalContextProvider({ show, children,
    initMessage, initType = "info" }: PropsWithChildren<NotificationModalContextProvider>) {
