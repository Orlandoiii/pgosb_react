    ...
    return (
        <div className="md:min-w-[600px] h-auto rounded-md border border-slate-200 p-2 shadow-sm   bg-gray-50">
            <button className="flex w-full items-center justify-between  gap-2  p-1 px-2 bg-[#0A2F4E] rounded-md shadow-md" onClick={() => { setOpen(o => !o) }}>
                <div className="">
                    <h4 className="text-left text-title-xsm font-bold text-[whitesmoke]">{title}</h4>
                </div>
                <div className="flex h-[28px]  w-[28px] items-center justify-center rounded-full border-2 border-[whitesmoke] dark:border-white">
                    <svg className={`fill-[whitesmoke] transition-all duration-200 ease-in-out w-[14px] h-[14px] ${open ? "hidden" : "block"}`} viewBox="0 0 15 15" xmlns="http://www.w3.org/2000/svg">
                    ...
                    <svg className={`fill-[whitesmoke] transition-all duration-200 ease-in-out w-[14px] h-[14px] ${open ? "block" : "hidden"}`} viewBox="0 0 15 3" xmlns="http://www.w3.org/2000/svg">
