...
export function CloseXSimbol({ onClose }) {
    return (
        <button
            className="w-7 bg-rose-700 rounded-full p-2 
        ...
        bg-slate-100 shadow-lg shadow-gray-400 "
                    >
                        ...
                        {title && title.length > 0 && (
                            <h2
                                className="relative w-full bg-[#0A2F4E] rounded-t-xl flex justify-center items-center
            text-[whitesmoke] text-lg h-11 p-2 shadow-lg"
                            >
                                {title}
                            </h2>
                        )}
                        ...
                        <div className="absolute">{downStikyChildren}</div>
