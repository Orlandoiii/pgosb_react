...
function MessageIcon() {
    return (
        <span className="absolute top-1/2 right-4 transform -translate-y-1/2 ">
            <svg className="fillCurrent" width="22" height="22" viewBox="0 0 22 22" fill="black"
