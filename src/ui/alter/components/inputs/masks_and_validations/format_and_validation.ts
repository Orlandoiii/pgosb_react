import { formatDate } from "../../../formatters/date_formatters";
import { isValidAccount, isValidAgentAccount, isValidClientAccount } from "../../../validators/account_validators";
...
function formatAsDecimal(value: string, initValue: string): string {
  throw new Error("Function not implemented.");
}

function formatAsInt(value: string): string {
  throw new Error("Function not implemented.");
}

function formatDateTime(value: string, arg1: string, arg2: string): string {
  throw new Error("Function not implemented.");
}
