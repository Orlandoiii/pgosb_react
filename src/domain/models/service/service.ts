...
export const ApiServiceSummarySchema = z.object({
    ...
    num_services: z.string().optional().default(""),
    unharmed: z.string().optional().default(""),
    injured: z.string().optional().default(""),
    transported: z.string().optional().default(""),
    deceased: z.string().optional().default(""),
    ...
    operative_areas: z.string().optional().default(""),
    num_authorities: z.string().optional().default(""),
    num_authority_services: z.string().optional().default(""),
    num_authority_person: z.string().optional().default(""),
    is_important: z.boolean().optional().default(false),
    num_authority_vehicle: z.string().optional().default(""),
